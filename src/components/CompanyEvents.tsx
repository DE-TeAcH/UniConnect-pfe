                            ...
                            <ScrollArea className="max-h-[55vh] pr-4">
                                <div className="space-y-4 text-sm">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        {[{ label: 'Creator', value: selectedEvent.creator_name || '—' }, { label: 'Location', value: selectedEvent.location }, { label: 'Start', value: `${formatDate(selectedEvent.start_date)}${selectedEvent.start_time ? ' at ' + selectedEvent.start_time : ''}` }, { label: 'End', value: `${formatDate(selectedEvent.end_date)}${selectedEvent.end_time ? ' at ' + selectedEvent.end_time : ''}` }, { label: 'Registrations', value: (selectedEvent.registration_count || 0).toString() }, { label: 'Category', value: selectedEvent.category_name || '—' }, { label: 'Type', value: selectedEvent.is_paid ? `Paid – ${selectedEvent.price} DZD` : 'Free' }].map(({ label, value }) => (
